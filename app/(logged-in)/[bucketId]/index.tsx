...
function TransactionView(props: {
  transaction: { title: string; amount: number; date: string | number, profile?: { id: string; name: string } | undefined };
}) {
  const { title, amount, date, profile } = props.transaction;
  ...
  return (
    ...
    >
      <View>
        ...
        {profile && <Text className="text-xs text-gray-500">
          {profile.name}
        </Text>}
      </View>
